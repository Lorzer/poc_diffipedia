...
export const WikipediaDisplay: React.FC<WikipediaDisplayProps> = ({ textContent, sourceUrl }) => {
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="text-gray-300 leading-relaxed space-y-4 overflow-y-auto">
